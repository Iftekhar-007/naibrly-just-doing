...
//     setSelectedRequest(row); // Set the selected request for the dialog
...
//                     onClick={() => handleApproveClick(row)} // Open the dialog when clicked
//                   >
//                     Approve
//                   </Button>
//                 </div>
...
//               Cancel
//             </Button>
//             <Button className="bg-[#0E7A60] hover:bg-[#0E7A60] text-white" onClick={() => setOpenDialog(false)}>
//               Approve Request
//             </Button>
//           </DialogFooter>
//         </DialogContent>
